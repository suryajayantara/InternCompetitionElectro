...
<main>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="container-fluid">
                <h1 class="mt-4 display-4">Mobile Legend </h1>
            ...
            <div class="col-md-12 mt-3">
              ...
              <h4 class="ml-4 mt-2 display-4"> {{ $data->nama_team }} Team </h4>
              <hr>
              <p class="lead ml-4">Kelas : {{$data->kelas}} </p>
              <p class="lead ml-4" style="margin-top:-1rem">Prodi : {{$data->prodi}} </p>
