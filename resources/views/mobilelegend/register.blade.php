          ...
          <div class="row">
              ...
              <div class="col-md-12">
                  <div class="shadow-lg card ">
                      <div class="card-body">
                          <form action="/ml/register/process" method="post">
                              {{ csrf_field() }}
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                  <input type="text" name="nama_team" class="form-control" id="inputPassword">
                                </div>
                              </div>
                              <div class="form-group row">
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                  <input type="test" name="alamat" class="form-control" id="inputPassword">
                                </div>
                              </div>
                              <hr>
                              ...
                              <div class="form-group row">
                                <label for="inputPassword" class="col-sm-2 col-form-label">ID GAMES </label>
                                <div class="col-sm-10">
                                  <input type="number" name="idgame1" class="form-control" id="inputPassword">
                                </div>
                              </div>
                              ...
                              <div class="form-group row">
                                <label for="inputPassword" class="col-sm-2 col-form-label">ID GAMES </label>
                                <div class="col-sm-10">
                                  <input type="number" name="idgame2" class="form-control" id="inputPassword">
                                </div>
                              </div>
                              ...
                              <div class="form-group row">
                                <label for="inputPassword" class="col-sm-2 col-form-label">ID GAMES </label>
                                <div class="col-sm-10">
                                  <input type="number" name="idgame3" class="form-control" id="inputPassword">
                                </div>
                              </div>
                              ...
                              <div class="form-group row">
                                <label for="inputPassword" class="col-sm-2 col-form-label">ID GAMES </label>
                                <div class="col-sm-10">
                                  <input type="number" name="idgame4" class="form-control" id="inputPassword">
                                </div>
                              </div>
                              ...
                              <hr>
                              <div class="form-group row">
                                <label for="inputPassword" class="col-sm-2 col-form-label">Nama Peserta 5</label>
                                <div class="col-sm-10">
                                  <input type="text" name="nama5" class="form-control" id="inputPassword">
                                </div>
                              </div>
                              <div class="form-group row">
                                <label for="inputPassword" class="col-sm-2 col-form-label">Nim Peserta 5</label>
                                <div class="col-sm-10">
                                  <input type="number" name="nim5" class="form-control" id="inputPassword">
                                </div>
                              </div>
                              <div class="form-group row">
                                <label for="inputPassword" class="col-sm-2 col-form-label">ID GAMES </label>
                                <div class="col-sm-10">
                                  <input type="number" name="idgame5" class="form-control" id="inputPassword">
                                </div>
                              </div>
                              <hr>
