...
class InstalasiPeneranganController extends Controller
{
    /**
    ...
    {
        return view('instalasipenerangan/index');
    }
    ...
    {
        return view('instalasipenerangan/register');
    }
    ...
    {
        // $checkData = InstalasiPenerangan::where('nim',$request->nim)->count();
        // if($checkData > 0){
        ...
        // Insert Data Try
        try {
            $query = InstalasiPenerangan::create([
                'nama' => $request->nama,
                'nim' => $request->nim,
                'kelas' => $kelas,
                'no_telpon' => $no_telpon,
